...
define( 'NOTIFIER_THEME_NAME', 'WooShop' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'wooshop' ); // The theme folder name
define( 'NOTIFIER_THEME_LATEST_VERSION', '2-3-4' ); // Latest version of the theme
define( 'NOTIFIER_XML_FILE', 'http://cdn.dessky.com/notifiers/wooshop-notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
